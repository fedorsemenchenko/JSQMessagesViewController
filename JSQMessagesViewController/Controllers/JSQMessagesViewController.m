...
//        cell.messageBubbleTopLabel.textInsets = UIEdgeInsetsMake(0.0f, bubbleTopLabelInset, 0.0f, 0.0f);
    ...
    CGSize finalCellSize = [self.collectionView.collectionViewLayout sizeForItemAtIndexPath:indexPath];
    [cell setFramesWithMessageData:messageItem isOutgoingMessage:isOutgoingMessage withSize:finalCellSize];
...
- (BOOL)collectionView:(JSQMessagesCollectionView *)collectionView shouldShowMenuForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id<JSQMessageData> messageItem = [collectionView.dataSource collectionView:collectionView messageDataForItemAtIndexPath:indexPath];
    if ([messageItem messageType] == MessageTypeImage || [messageItem messageType] == MessageTypeImageWithText) {
        return NO;
    }
